        ...
        <div class="container">
            ...
            <main>
                ...
                <div class="row">
                    ...
                    <form method="POST" action="guardarproductomodificado">                      
                        <div class="col-md-1">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div hidden class="row">
                                        <div class="col-lg-12" style="margin-top: 20px;">
                                            ...
                                            <input type="text" class="form-control" id="usr" name="id_producto" value="<%=producto.getId_producto()%>">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6" style="margin-top: 20px;">
                                            ...
                                            <input type="text" class="form-control" id="usr" name="nombre" value="<%=producto.getNombre()%>">
                                        </div>
                                        <div class="col-lg-6" style="margin-top: 20px;">
                                            <label for="usr" style="font-size: 14px; font-weight: 600; color: #e59201;">Categoría</label>
                                            <select class="form-control" id="sel1" value="<%=producto.getId_categoria()%>" name="categoria" required="">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6" style="margin-top: 20px;">
                                            ...
                                            <input type="text" class="form-control" id="usr" name="precio" value="<%=producto.getPrecio()%>">
                                        </div>
                                        <div class="col-lg-6" style="margin-top: 20px;">
                                    ...
                                    <div class="row" style="margin-top: 20px;">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea class="form-control" rows="5" id="comment" name="preparacion"><%=producto.getPreparacion()%></textarea>
                                        </div>                                    
                                    </div><br>
                                    <div class="row">
                                        <div class="col-lg-12">
