                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table table-condensed" style="color: white; margin-top: 40px;">
                                    ...
                                    <% List<Venta> listaVenta = (List<Venta>) request.getAttribute("listaVentas"); %>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=listaVenta1.getPax()%></td>   
                                           
                                        <td><a href="verdetallepedido?idVenta=<%=listaVenta1.getId_venta()%>" class="form-control" style="color: #ff3333; font-weight: bold; font-size: 13px; text-align: center">Ver</a></td>                                      
