...
<%@page import="pe.edu.ulima.model.Cliente"%>
...
<html>
    ...
    <body style="background-color: #551213;">
        ...
        <div class="container">
                    ...
                    <header>
                        ...
                        <nav class="menu">
                            <ul>
                                ...
                                <li><a href="visualizarreservas">Reserva</a></li>
            ...
            <main>
                <form method="POST" action="grabarreservamodificada">
                    <div class="row">
                        <div class="col-md-1">

                        </div>
                        <div class="col-md-10 color_fondo">
                            <% Reserva reserva = (Reserva) request.getAttribute("reservita");%>
                            <% Cliente cliente = (Cliente) request.getAttribute("clientito");%>
                            <div hidden class="row">
                                <div class="col-lg-12" style="margin-top: 20px;">
                                    <label for="usr" style="font-size: 14px; font-weight: 600; color: #e59201;">Id:</label>
                                    <input type="text" class="form-control" id="usr" name="idReserva" value="<%=reserva.getId_reserva()%>">
                                </div>
                            </div>  
                            <div hidden class="row">
                                <div class="col-lg-12" style="margin-top: 20px;">
                                    <label for="usr" style="font-size: 14px; font-weight: 600; color: #e59201;">Id:</label>
                                    <input type="text" class="form-control" id="usr" name="idCliente" value="<%=cliente.getId_cliente()%>">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">            
                                        <div class="col-md-10">                                                                                     
                                            ...
                                            <input id='nombres' name="nombre" value="<%=cliente.getNombre()%>" required class="form-control">
                                            <label style="color: #9c917a">Apellidos:</label>
                                            <input id='apellidos' name="apellido" value="<%=cliente.getApellido()%>" required class="form-control">
                                            <label style="color: #9c917a">Teléfono:</label>
                                            <input id='telefono' name="telefono" required value="<%=cliente.getTelefono()%>" class="form-control">
                                            <label style="color: #9c917a">Email:</label>
                                            <input type="email" id='email' name="correo" value="<%=cliente.getCorreo()%>" required class="form-control">   
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input style="width: 80px;" required id='nombres' name="pax" value="<%=reserva.getPax()%>" class="form-control">
                                        </div>
                                        <div class="col-md-12">
                                            <label style="color: #9c917a;">Fecha:</label>
                                            <div class="row">
                                                <div class="col-md-4"> 
                                                    <select required class="form-control" name="dia" style="width: 80px;">
                                                ...
                                                <div class="col-md-4">
                                                    <select required class="form-control" name="mes" style="width: 80px;">
                                                ...
                                                <div class="col-md-4">
                                                    <select required class="form-control" name="ano" style="width: 80px;">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select required class="form-control" name="hora" style="width: 80px;">
                                ...
                                <div class="col-md-6">
                                    <div class="row">            
                                        <div class="col-md-10">
                                            ...
                                            <textarea class="form-control" name="comentario"  rows="6"><%=reserva.getComentario()%></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <input type="submit" class="btn btn-warning" value="Guardar reserva"/>                                       
                                        </div>
                                    </div>
                                    <div class="row"><br>
                                        <div class="col-lg-12">
