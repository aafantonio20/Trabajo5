                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6" style="margin-top: 20px;">
                                            ...
                                            <input type="text" class="form-control" value="<%=producto.getNombre()%>" id="usr" name="nombre" required="">
                                        </div>
                                        <div class="col-lg-6" style="margin-top: 20px;">
                                            <label for="usr" style="font-size: 14px; font-weight: 600; color: #e59201;">Precio:</label>
                                            <input type="text" class="form-control" value="<%=producto.getPrecio()%>" id="usr" name="precio" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top: 20px;">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea class="form-control" rows="5" id="comment" name="preparacion" required=""><%=producto.getPreparacion()%></textarea>
                                        </div>    
                                        <div class="col-lg-6">
